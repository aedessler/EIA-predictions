#!/usr/bin/env python3
"""
Thermal Fuel Price Projections Charts

EIA AEO price projections (AEO 2008–2026) vs. actual historical data:
  - Natural gas delivery to electric power  (real $/Mcf)
  - Steam coal to electric power            (real $/MMBtu)
  - Crude oil import price                  (real $/barrel)
  - Nuclear fuel to electric power          (nominal $/MMBtu)

Run: python price_chart.py
Outputs: output/prices/*_projections.png
"""
